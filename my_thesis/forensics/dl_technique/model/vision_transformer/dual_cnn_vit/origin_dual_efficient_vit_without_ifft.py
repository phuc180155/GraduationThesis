...
class OriginDualEfficientViTWithoutIFFT(nn.Module):
    def __init__(self, channels=1280,\
                 ...
                 dropout_in_mlp=0.0, pretrained=True):  
        super(OriginDualEfficientViTWithoutIFFT, self).__init__()
...
if __name__ == '__main__':
    ...
    model_ = OriginDualEfficientViTWithoutIFFT(image_size=256, patch_size=2)
    out = model_(x, y)
    print(out.shape)