...
import cv2
import dlib
import headpose_forensic.utils.face_utils
from headpose_forensic.utils import pose_utils as pu
import argparse
import os
...
class PoseEstimator(object):
    ...
    def __init__(self, img_size, model_path='headpose_forensic/models/model_landmark.txt'):
