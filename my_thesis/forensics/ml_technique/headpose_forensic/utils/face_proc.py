...
import numpy as np
import dlib
from headpose_forensic.utils.proc_vid import parse_vid
from headpose_forensic.utils.face_utils import shape_to_np
...
class FaceProc(object):
    ...
    def __init__(self):
        ...
        self.landmark_estimatior= dlib.shape_predictor(dat_file)
