...
def heatmap(data, row_labels, col_labels, ax=None,
    ...
    **kwargs
    ...
    ax.set_yticklabels(row_labels, fontweight='bold', fontsize=14)
...
with open(data_path, 'r', encoding='utf-8') as file:
    for line in file:
        ...
        for ele in data_line:
            if not 'x' in ele:
                new_data_line.append(float(ele))
            else:
...
# detech_teches = 
detech_techs = ["Meso4", "Capsule", "XceptionNet", "GAN-fp", "FDBD", "HPBD", "VA"]
...
im, cbar = heatmap(data_block, detech_techs, noises,  ax=ax,
                cmap="OrRd", cbarlabel="harvest [t/year]",
