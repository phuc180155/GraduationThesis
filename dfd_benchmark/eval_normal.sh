...
python eval.py --val_set /hdd/tam/dfd_benmark/dfdc/image/test/ --batch_size 32 --image_size 128 --workers 16 --checkpoint normal_dfdc_checkpoint --resume model_best.pt  --gpu_id 1    normal
