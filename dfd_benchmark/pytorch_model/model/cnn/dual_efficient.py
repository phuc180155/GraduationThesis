...
class DualEfficient(nn.Module):
    def __init__(self):
        ...
        self.efficient3 = EfficientNet.from_pretrained('efficientnet-b0', num_classes=1,in_channels = 3,pretrained=False)
        self.efficient3._dropout = Identity()
        self.efficient3._fc = Identity()
        self.efficient1 = EfficientNet.from_pretrained('efficientnet-b0', num_classes=1,in_channels = 1,pretrained=False)
