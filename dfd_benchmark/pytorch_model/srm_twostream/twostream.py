...
from pytorch_model.srm_twostream.attention import ChannelAttention, SpatialAttention, DualCrossModalAttention
from pytorch_model.srm_twostream.srm_conv import SRMConv2d_simple, SRMConv2d_Separate
from pytorch_model.srm_twostream.transfermodel import TransferModel
...
class Two_Stream_Net(nn.Module):
    def __init__(self):
        ...
        self.xception_rgb = TransferModel(
            'xception', dropout=0.5, inc=3, return_fea=True,num_out_classes=1)
